<nav class="bg-gray-800">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <?php if ($_SESSION['user'] ?? false) : ?>
                            <a href="/laracast-path/Day6/notes"
                        ...
                        <?php endif ?>
                        <a href="/laracast-path/Day6/contact"
            ...
            <div class="hidden md:block">
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <?php if ($_SESSION['user'] ?? false) : ?>
                        ...
                        <div class="ml-3">
                            <form method="POST" action="/laracast-path/Day6/session">
                    ...
                    <?php else : ?>
                        <div class="ml-3">
                            <a href="/laracast-path/Day6/register"
                            ...
                            <a href="/laracast-path/Day6/login"
    ...
    <div class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
            <a href="/laracast-path/Day6#" class="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium"
